...
export default function AddBook() {
  ...
  const submitHandler = (event) => {
    ...
    if (bookName && bookAuthor && borrowedBy && borrowedDate && returnDate) {
      const newBook = {
        bookName,
        bookAuthor,
        borrowedBy,
  ...
  return ( 
    <div>
      ...
      <div class="container bg-light mt-5">
        <h1 className="text-center pt-5">Add New Issued Book</h1>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="borrowedBy" name="borrowedBy" maxLength="30" onChange={(e) => setborrowedBy(e.target.value)} required
    />
  </div>
  <div class="col-md-6">
  ...
  <div class="col-12">
    <button type="submit" class="btn btn-primary" id="submit">Add New Issued Book</button>
  </div>
</form>

</div>
<div class="container mt-5 bg-light p-5">
  <h1 class="text-center mb-5">Issued Book List</h1>
      <table class="table">
